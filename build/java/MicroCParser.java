...
public class MicroCParser extends Parser {
	...
	public static final int
		...
		RULE_if_stmt = 20, RULE_else_stmt = 21, RULE_while_stmt = 22, RULE_primary = 23, 
		RULE_unaryminus_expr = 24, RULE_call_expr = 25, RULE_arg_list = 26, RULE_args_rest = 27, 
		RULE_expr = 28, RULE_term = 29, RULE_cond = 30, RULE_cmpop = 31, RULE_mulop = 32, 
		RULE_addop = 33;
	...
	public final Func_declContext func_decl() throws RecognitionException {
		...
		try {
			...
			setState(115);
			match(T__0);
			st.addFunction(((Func_declContext)_localctx).base_type.t, (((Func_declContext)_localctx).ident!=null?_input.getText(((Func_declContext)_localctx).ident.start,((Func_declContext)_localctx).ident.stop):null), ((Func_declContext)_localctx).params.types);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
		...
		try {
			...
			match(T__6);
			          ...
			          if ((ste == null) || !ste.isDefined()) {
			               st.addFunction(((FunctionContext)_localctx).base_type.t, (((FunctionContext)_localctx).ident!=null?_input.getText(((FunctionContext)_localctx).ident.start,((FunctionContext)_localctx).ident.stop):null), ((FunctionContext)_localctx).params.types);          
	...
	public final ParamContext param() throws RecognitionException {
		...
		try {
			...
			((ParamContext)_localctx).name =  (((ParamContext)_localctx).ident!=null?_input.getText(((ParamContext)_localctx).ident.start,((ParamContext)_localctx).ident.stop):null); ((ParamContext)_localctx).type =  ((ParamContext)_localctx).base_type.t;
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
